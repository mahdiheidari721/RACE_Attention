...
@triton.autotune(
    configs=[
        # 128x128 exceeds shared memory on GPUs with <112KB limit (e.g. sm_86 cap=99KB)
        ...
        # BLOCK_m=128, BLOCK_n=64 is buggy with num_warps=4; num_warps=8 may work but skipping to be safe
